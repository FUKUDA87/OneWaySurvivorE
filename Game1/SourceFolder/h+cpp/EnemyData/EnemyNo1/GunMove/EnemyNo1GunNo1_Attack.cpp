...
C_ENo1_GNo1_Attack::C_ENo1_GNo1_Attack(S_ENEMYGUNDATA * s_Data)
{
	*s_Data=InitData();
	Init();
}

C_ENo1_GNo1_Attack::C_ENo1_GNo1_Attack()
{
	Init();
}

C_E_GunMoveBase * C_ENo1_GNo1_Attack::Move(S_ENEMYGUNDATA * s_Data, int * NowPhase)
{
	if (*NowPhase <= Phase0)return nullptr;
...
S_ENEMYGUNDATA C_ENo1_GNo1_Attack::InitData(void)
{
	S_ENEMYGUNDATA Data;
...
void C_ENo1_GNo1_Attack::Init(void)
{
	InitFlg = true;
	RayCount = RayCountMax = 20;
}

void C_ENo1_GNo1_Attack::InitRot(S_ENEMYGUNDATA * s_Data)
{
...
bool C_ENo1_GNo1_Attack::Ray(S_ENEMYGUNDATA * s_Data)
{
